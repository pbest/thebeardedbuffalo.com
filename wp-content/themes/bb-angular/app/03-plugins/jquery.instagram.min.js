...
(function ($) {
    var settings = {
        authToken: "4289329.1fb234f.9ccf40b73ef048b288b43ae737a29003", // @eatpuesto
        loadingMessage: "Hold on, we're gathering images!", // This can be any html you want to show for loading
        count: 10,
        moreText: 'More',
        resetText: 'Reset',
        callback: '',
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.each(result.data, function (i) {
                    ...
                    $item.load(function () {
                        $(this).fadeIn('fast');
                    }).attr('src', this.images.standard_resolution.url);
